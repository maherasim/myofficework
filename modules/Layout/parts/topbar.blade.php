        ...
        <div class="content">
            ...
            <div class="topbar-right">
                ...
                @if(!Auth::id())
                        ...
                        <li class="signup-item">
                            <a href="#becomeHost" data-toggle="modal" data-target="#becomeHost" class="signup">{{__('Become a Host')}}</a>
                        </li>
                    @else
                        ...
                        <li class="login-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-user text-left">
                                ...
                                @endif
                                    <li class="menu-hr"><a href="{{route('user.bookings.details').'?type=history'}}"><i class="fa fa-clock-o"></i> {{__("Booking History")}}</a></li>
