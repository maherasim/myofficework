                ...
                <div class="col-md-3">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label>{{__('Super Host')}}</label>
                                <div class="form-controls">
                                    <select name="super_host" class="form-control">
                                        <option value="0" {{old("super_host",($row->super_host ?? '')) == 0 ? 'selected' : ''  }}>{{__('No')}}</option>
                                        <option value="1" {{old("super_host",($row->super_host ?? '')) == 1 ? 'selected' : ''  }}>{{__('Yes')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
