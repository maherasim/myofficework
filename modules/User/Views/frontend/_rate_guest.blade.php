<div class="modal fade" id="rateGuestSingleBooking<?= $booking->id ?>">
        ...
        <div class="modal-content">
            <form action="{{ route('review.store') }}" class="review-form needs-validation" novalidate method="post">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="status-single-booking-update-title">{{ __('Rate Guest') }}</h4>
                </div>
                <!-- Modal body -->
                <div class="modal-body pt-3">
                    ...
                    <div class="row">
                        ...
                        @if ($tour_review_stats = setting_item($row->type . '_review_stats'))
                            <?php
                            $tour_review_stats = [['title' => 'Behaviour'],['title' => 'Communication'],['title' => 'Payment'],['title' => 'Cleanliness']];
