...
Route::post('/updateUserCreditByUser/{id}', 'SearchController@updateUserCreditByUser')->name("api.checkout.update.user.credit.pay");
Route::post('/updatePaymentStatus/{id}', 'SearchController@updatePaymentStatus')->name("api.checkout.update.payment.status");
