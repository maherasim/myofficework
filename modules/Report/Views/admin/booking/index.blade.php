                                    ...
                                    @if($service = $row->service)
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a class="dropdown-item"
                                                   href="{{url('admin/module/report/booking/sendNotificationEmail/'.$row->id)}}">{{__('Send Notification Email')}}</a>
                                            </div>
                                        </div>
...
@section('script.body')
    <script>
        ...
        $(document).on("click", ".enableDateTimeInput", function () {
        ...
        $(document).on("click", ".updateBooking", function () {
            let btn = $(this);
            let updateBookingForm = btn.closest('.updateBookingForm');
            ...
            if (startTime != null && endTime != null) {
                ...
                $.post(updateBookingForm.attr("data-href"), {
