...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Referalprogram\Controllers';

    protected $adminModuleNamespace = 'Modules\Referalprogram\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware(['web','dashboard'])
            ...
            ->prefix('admin/module/referal-program')
