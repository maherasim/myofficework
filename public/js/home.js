...
jQuery(function ($) {
    ...
    if ($(".bravo-range-filter").length > 0) {
        $(".bravo-range-filter").each(function () {
            ...
            input_price.ionRangeSlider({
                ...
                onFinish: function (data) {
                    const mainField = $(data.input).closest(".bravo-range-filter");
                    mainField.find(".from").val(data.from);
                    mainField.find(".to").val(data.to);
                },
            });
        });
    }
