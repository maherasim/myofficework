...
<a href="mailto:contact@bookingcore.com">contact@bookingcore.com</a>',
        ...
        public function updateTo220()
        {
            ...
            Permission::findOrCreate('referal_view');
            Permission::findOrCreate('referal_create');
            Permission::findOrCreate('referal_update');
            Permission::findOrCreate('referal_delete');
